...
const CREDITS_INTRO = '\u{1F3C6} FULL CREDIT to every creator featured in this video! It takes real courage to put yourself on camera for the love of the game \u2014 please show them some love and subscribe to their channels below:';
const COPYRIGHT_BLOCK = 'Copyright Disclaimer: Under Section 107 of the Copyright Act 1976, allowance is made for "fair use" for purposes such as criticism, comment, news reporting, teaching, scholarship, and research. Fair use is a use permitted by copyright statute that might otherwise be infringing. Non-profit, educational, or personal use tips the balance in favor of fair use.';
...
function generate() {
  ...
  if (videoType === 'fan' || videoType === 'fanAway') {
    ...
    desc = reactingTeam + ' fans \u26BD\u{1F525} react to ' + tA + ' ' + score + ' ' + tB + ' \u2014 every goal, every moment, every emotion. Watch die-hard ' + reactingTeam + ' supporters experience every goal \u26BD, every near-miss \u{1F62C}, and every heart-stopping moment \u{1F631} of this ' + comp + ' match in real time. From pure ecstasy \u{1F973} to absolute heartbreak \u{1F494} \u2014 this is what football means to real fans. \u26A1\n\n\u23F1\uFE0F TIMESTAMPS\n' + tsBlock + '\n\n\u{1F4FA} FAN CHANNELS IN THIS VIDEO\n' + CREDITS_INTRO + '\n' + chBlock + '\n\n\u2014\n\n' + PROMO_BLOCK + '\n\n\u{1F514} Subscribe for fan reaction compilations posted the moment the final whistle blows \u2014 Premier League and Champions League every matchday.\n\n' + social + '\n\n\u2014\n\n' + COPYRIGHT_BLOCK;
    ...
    desc = tA + ' and ' + tB + ' fans \u26BD\u{1F525} react to ' + tA + ' ' + score + ' ' + tB + ' \u2014 every goal, every moment, every emotion from both sides. Watch die-hard supporters from both clubs experience every goal \u26BD, every near-miss \u{1F62C}, and every heart-stopping moment \u{1F631} of this ' + comp + ' match in real time. From pure ecstasy \u{1F973} to absolute heartbreak \u{1F494} \u2014 this is what football means to real fans. \u26A1\n\n\u23F1\uFE0F TIMESTAMPS\n' + tsBlock + '\n\n\u{1F4FA} FAN CHANNELS IN THIS VIDEO\n' + CREDITS_INTRO + '\n' + chBlock + '\n\n\u2014\n\n' + PROMO_BLOCK + '\n\n\u{1F514} Subscribe for fan reaction compilations posted the moment the final whistle blows \u2014 Premier League and Champions League every matchday.\n\n' + social + '\n\n\u2014\n\n' + COPYRIGHT_BLOCK;
    ...
    desc = rival + ' fans \u{1F608}\u{1F525} react to ' + tB + "'s " + score + ' defeat \u2014 and they are absolutely loving every second of it \u{1F923}. Watch rival supporters celebrate \u{1F389}, mock \u{1F60F}, and revel in ' + tB + "'s misery \u{1F480} as the goals go in \u26BD. Pure schadenfreude. This is football at its most ruthless. \u{1F602}\n\n\u23F1\uFE0F TIMESTAMPS\n" + tsBlock + '\n\n\u{1F4FA} FAN CHANNELS IN THIS VIDEO\n' + CREDITS_INTRO + '\n' + chBlock + '\n\n\u2014\n\n' + PROMO_BLOCK + '\n\n\u{1F514} Subscribe \u2014 new reaction compilations posted at full time, every Premier League and Champions League matchday.\n\n' + social + '\n\n\u2014\n\n' + COPYRIGHT_BLOCK;
    ...
    desc = tA + ' ' + score + ' ' + tB + ' \u26BD \u2014 post-match fan reactions. Watch ' + tA + ' and ' + tB + ' fans process what just happened \u{1F92F}. The highs \u{1F973}, the lows \u{1F61E}, the disbelief \u{1F632}, the fury \u{1F621} \u2014 unfiltered and in real time. \u{1F3A4}\n\n\u23F1\uFE0F TIMESTAMPS\n' + tsBlock + '\n\n\u{1F4FA} FAN CHANNELS IN THIS VIDEO\n' + CREDITS_INTRO + '\n' + chBlock + '\n\n\u2014\n\n' + PROMO_BLOCK + '\n\n\u{1F514} Subscribe \u2014 post-match reactions and fan compilation videos every Premier League and Champions League matchday.\n\n' + social + '\n\n\u2014\n\n' + COPYRIGHT_BLOCK;
    ...
    desc = tA + ' fans \u{1F4F2}\u{1F525} react to ' + tName + ' ' + vd + ' ' + tA + '. Every emotion \u{1F622}\u{1F606}, every take, unfiltered \u2014 this is what it means to be a football fan when the news breaks. \u{1F6A8}\n\n\u{1F4FA} FAN CHANNELS IN THIS VIDEO\n' + CREDITS_INTRO + '\n' + chBlock + '\n\n\u2014\n\n' + PROMO_BLOCK + '\n\n\u{1F514} Subscribe \u2014 reaction compilations posted immediately as the news breaks.\n\n' + social + '\n\n\u2014\n\n' + COPYRIGHT_BLOCK;
